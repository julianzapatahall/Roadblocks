...
class computations:
    ...
    """
    full_matrix = matrix
    first_sliced_matrix = get_time_slice(full_matrix, start=0., period=1.)
    print(first_sliced_matrix)

    full_matrix = matrix
    second_sliced_matrix = get_time_slice(full_matrix, start=0.5, period=1.5)
    print(second_sliced_matrix)
    third_sliced_matrix = get_time_slice(full_matrix, start=1.5, period=2.5)
    print(third_sliced_matrix)
    fourth_sliced_matrix = get_time_slice(full_matrix, start=1.5, period=2.5)
    print(fourth_sliced_matrix)
    """
    ...
    # half_backward_difference_mean = feature_mean_d(first_sliced_matrix, second_sliced_matrix)
    # print(half_backward_difference_mean)
    ...
    # quarter_backward_difference_mean = feature_mean_q(first_sliced_matrix, second_sliced_matrix, third_sliced_matrix, fourth_sliced_matrix)
    # print(quarter_backward_difference_mean)
    ...
    # stddev_matrix = feature_stddev(first_sliced_matrix)
    # print(stddev_matrix)
    ...
    # half_backward_difference_stddev = feature_stddev_d(first_sliced_matrix, second_sliced_matrix)
    # print(half_backward_difference_stddev)
    ...
    # feature_moments_matrix = feature_moments(first_sliced_matrix)
    # print(feature_moments_matrix)
    ...
    # max_matrix = feature_max(first_sliced_matrix)
    # print(max_matrix)
    ...
    # half_backward_difference_max = feature_max_d(first_sliced_matrix, second_sliced_matrix)
    # print(half_backward_difference_max)
    ...
    # quarter_backward_difference_max = feature_max_q(first_sliced_matrix, second_sliced_matrix, third_sliced_matrix, fourth_sliced_matrix)
    # print(quarter_backward_difference_max)
    ...
    # min_matrix = feature_min(first_sliced_matrix)
    # print(min_matrix)
    ...
    # half_backward_difference_min = feature_min_d(first_sliced_matrix, second_sliced_matrix)
    # print(half_backward_difference_min)
    ...
    # quarter_backward_difference_min = feature_min_q(first_sliced_matrix, second_sliced_matrix, third_sliced_matrix, fourth_sliced_matrix)
    # print(quarter_backward_difference_min)
    ...
    # fft_matrix = feature_fft(first_sliced_matrix)
    # print(fft_matrix)
    ...
    #print('VAR VAR_NAMES:', var_names)
    #print('Var Val Length:', len(var_values), 'Var Val Names:', len(var_names) )
    #for var_name in var_names:
    #if var_names.count(var_name) > 1:
    #print(var_names, 'IS A DUPLICATE!')
    #print('Num unique cols:', len(np.unique(var_names)) )
    # calc_matrix = calc_feature_vector(first_sliced_matrix, "first_sliced_matrix")
    # print(calc_matrix)
